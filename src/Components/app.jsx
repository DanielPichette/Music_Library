...
class App extends Component {
    ...
    filtered(){
        ...
        let allSongs = this.state.songlist
    ...
    render() { 
        ...
        <div className="App">
            ...
            <div>
                <SongListTable key="key" songlist={this.state.filteredSearch}  song={this.state.songs[this.state.songNumber]} searchInput={this.state.searchInput}/>
            </div>
            <div>
                <h2>Add Song</h2>
